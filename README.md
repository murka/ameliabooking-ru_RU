...
## Условия
Имейте совесть не выдавать перевод за свой и продавать его "как либо". Этот перевод выполнен бесплатно для всех пользователей. Автор не расчитывает на вашу финансовую поддержку, но Вы его всегда можете отблагодарить, отправив тёплые слова нам на почту ниже.
